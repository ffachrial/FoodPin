...
//  FoodPin
//
//  Created by Firman Fachrial on 13/08/22.
//
...
struct RestaurantListView_Previews: PreviewProvider {
    static var previews: some View {
        ...
        FullImageRow(imageName: "cafedeadend", name: "Cafe Deadend", type: "Cafe", location: "Hongkong", isFavorite: .constant(true))
            .previewLayout(.sizeThatFits)
            .preferredColorScheme(.dark)
    }
}
    ...
    var body: some View {
        ...
        .alert(isPresented: $showError) {
            Alert(title: Text("Not yet available"),
                  message: Text("Sorry, this feature is not available yet. Please retry again later."),
